...
import { PlayfairText, PlayfairFile } from "@/components";
    ...
    return (
        <div className="relative h-screen w-full overflow-y-auto overflow-x-hidden md:px-7 px-6">
            ...
            <div className="z-200 relative">
                <h1 className="text-3xl font-bold mb-1">Playfair Cipher</h1>
                <h3 className="text-lg mb-5">Shuffle your plaintext into a grid for secret code fun!</h3>
            </div>
